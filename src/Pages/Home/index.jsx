  ...
  return (
    <div className="fifth_bg">
      ...
      <div className="total3 mt40 fifth_bg">
        <div className="container">
          <div className="row">
            <div className="col-md-12 col-xl-8">
              ...
              <BusinessCarousel data={technology?.data?.slice(0, 5)} />
              <BusinessImageCarousel
                dataOne={business?.data?.slice(0, 3)}
                dataTwo={science?.data?.slice(0, 5)}
              />
            </div>
            <div className="col-md-6 col-xl-4 d-md-none d-xl-block">
              <WidgetFinanceTwo
                data={technology?.data?.slice(5, 7)}
                title="Technology"
              />
        ...
        <NewsSection data={business?.data?.slice(3, 14)}/>
      </div>
          ...
          <div className="row">
            <div className="col-md-12 col-xl-8">
              ...
              <div className="banner_area mb30 xs-mt60">
                <Link to="/">
                  <img src="https://preview.colorlib.com/theme/magnews2/images/banner-01.jpg" alt="banner42" />
                </Link>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <GalleryCarousel data={general?.data?.slice(21, 23)} />
                </div>
              </div>
            </div>
            <div className="col-md-12 col-xl-4">
              <div className="row">
                ...
                <div className="col-md-6 col-xl-12">
                  <CategoryFour />
                  <WidgetFinanceTwo data={general?.data?.slice(23, 26)} title="Inernational" />
                  <div className="banner2 mb30 border-radious5  d-md-none d-xl-block">
                    <Link to="/">
                      <img src="https://preview.colorlib.com/theme/magnews2/images/banner-02.jpg" alt="banner4" />
                    </Link>
                  </div>
                </div>
              </div>
